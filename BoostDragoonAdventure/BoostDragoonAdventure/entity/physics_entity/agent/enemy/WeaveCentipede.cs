                        ...
                        if (target != null)
                        {
                            if (phase == 2 && counterShots % 2 == 1)
                            {
                                ...
                                if (rank == 2)
                                {
                                    ...
                                    SkillServer.GenerateProjectile(new Vector2(15f, 15f), new Vector2(300, 0), -25, 100, 300, ParticleServer.GenerateParticle(), "whsh", "attack1", 3, "all", Vector2.Zero, false), false));
