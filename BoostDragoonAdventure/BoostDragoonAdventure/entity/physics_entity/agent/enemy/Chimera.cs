...
namespace wickedcrush.entity.physics_entity.agent.enemy
{
    public class Chimera : Agent
    {
        ...
        public Chimera(int id, World w, Vector2 pos, EntityFactory factory, PersistedStats stats, SoundManager sound)
            : base(id, w, pos, new Vector2(200f, 200f), new Vector2(100f, 100f), false, factory, sound)
        {
