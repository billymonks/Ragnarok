...
namespace wickedcrush.entity.physics_entity.agent.enemy
{
    ...
    public class KnightEnemy : Agent
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            switch (enemyState)
            {
                case EnemyState.Alert:
                    angledSpriters["Face"].player.setAnimation("alert", 0, 0);
                    //SetCostume(0);
                    //SetCostume(0);
                    //angledSpriters["Face"]
                ...
                case EnemyState.Search:
                    angledSpriters["Face"].player.setAnimation("normal", 0, 0);
                    //SetCostume(0);
                    //RemoveAngledElement("Face");
        ...
        protected override void SetupSpriterPlayer()
        {
            ...
            InitializeHumanoidCharacterSprites(torsoScale, armWidth, legWidth, armStance, legStance, spineStance, "knight");
