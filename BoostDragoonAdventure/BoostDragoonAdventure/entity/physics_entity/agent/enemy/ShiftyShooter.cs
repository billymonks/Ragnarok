        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (timers["shoot"].isDone())
            {
                ...
                if (target != null)
                {
                    ...
                    SkillServer.GenerateProjectile(new Vector2(10f, 10f), new Vector2(500f, 0f), -10, 100, 800, ParticleServer.GenerateParticle(), "whsh", "attack1", 3, "all", Vector2.Zero, false), true), 
