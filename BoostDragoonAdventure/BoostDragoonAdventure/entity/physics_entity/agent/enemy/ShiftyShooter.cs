        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (timers["shoot"].isDone())
            {
                ...
                if (target != null)
                {
                    ...
                    spreadDuration, blowCount, blowPerSpread, scatterCount, spread, false, blowVelocity, blowDuration, 30, 1f, new Nullable<ParticleStruct>(new ParticleStruct(Vector3.Zero, Vector3.Zero, new Vector3(-0.3f, -0.3f, -0.3f), new Vector3(0.6f, 0.6f, 0.6f), new Vector3(0f, -0.03f, 0f), 0f, 0f, 500, 100, "particles", 0, "white_to_green")), "", 0, "",
