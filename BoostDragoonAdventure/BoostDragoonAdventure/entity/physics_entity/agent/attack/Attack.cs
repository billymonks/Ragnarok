...
namespace wickedcrush.entity.physics_entity.agent.attack
{
    public abstract class Attack : Agent
    {
        ...
        public Attack(int id, World w, Vector2 pos, Vector2 size, Vector2 center, bool solid, int damage, int force, SoundManager sound, EntityFactory factory)
            : base(id, w, pos, size, center, solid, factory, sound)
        {
            Initialize(damage, force);
        }

        public Attack(int id, World w, Vector2 pos, Vector2 size, Vector2 center, bool solid, Entity parent, int damage, int force, SoundManager sound, EntityFactory factory)
            : base(id, w, pos, size, center, solid, factory, sound)
        {
            this.parent = parent;
            Initialize(damage, force);
