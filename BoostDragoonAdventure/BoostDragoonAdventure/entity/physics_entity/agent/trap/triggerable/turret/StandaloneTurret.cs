...
namespace wickedcrush.entity.physics_entity.agent.trap.triggerable.turret
{
    public class StandaloneTurret : Triggerable
    {
        ...
        int spreadDuration = 40, blowCount = 8, blowPerSpread=4, scatterCount = 0, spread=10, blowDuration = 200, blowReleaseDelay = 0, shotTimer = 333, rank = 3;


        public StandaloneTurret(World w, Vector2 pos, EntityFactory factory, Direction facing, SoundManager sound, int rank)
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (timers["shot"].isDone())
            {
                useActionSkill(SkillServer.GenerateSkillStruct(new Vector2(0f, 0f), new Vector2(skillVelocity, 0f), 
                    ...
                    new Nullable<ParticleStruct>(new ParticleStruct(Vector3.Zero, Vector3.Zero, new Vector3(-0.3f, -0.3f, -0.3f), new Vector3(0.6f, 0.6f, 0.6f), new Vector3(0f, -0.03f, 0f), 0f, 0f, 500, 100, "particles", 0, "white_to_green")),
                    "", 0, "",
