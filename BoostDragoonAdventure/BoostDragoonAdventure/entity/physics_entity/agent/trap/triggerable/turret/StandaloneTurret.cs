...
namespace wickedcrush.entity.physics_entity.agent.trap.triggerable.turret
{
    public class StandaloneTurret : Triggerable
    {
        ...
        int spreadDuration = 40, blowCount = 8, blowPerSpread=4, scatterCount = 0, spread=20, blowDuration = 200, blowReleaseDelay = 0, shotTimer = 1000;


        public StandaloneTurret(World w, Vector2 pos, EntityFactory factory, Direction facing, SoundManager sound)
        ...
        private void Initialize(Direction facing)
        {
            ...
            timers.Add("shot", new Timer(shotTimer));
        }
